...
import com.pk4u.spinner.databinding.ActivitySpinnerBinding
import com.pk4u.spinner.databinding.DialogAddCharacterBinding
...
class SpinnerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            ActivitySpinnerBinding.inflate(layoutInflater).also { setContentView(it.root) }
